...
import pws.tugas1.exceptions.NonexistentEntityException;
import pws.tugas1.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws_tugas.111_jar_0.0.1-SNAPSHOTPU");
